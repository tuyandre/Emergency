						...
						<div class="row">
							...
							<div class="col-md-4">
								...
								<div class="row">
									...
									<div class="col-md-8"><span class="progress-text">{{$criminals[0]->populations['name']}}</span></div>
								</div>
<br><br><br>
									<div class="row">
										<div class="col-md-4"><strong style="color: dodgerblue">Message</strong></div>
										<div class="col-md-8"><span class="progress-text">{{$criminals[0]->Message}}</span></div>
									</div>
								</div>
