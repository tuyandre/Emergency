			...
			<div class="col-md-12">
				<div class="box box-success flat">
					<div class="box-header with-border">
						<h1 class="box-title">Manage Road accidents</h1>
				...
				columns: [
					...
					{data: 'location'},
					{
						...
						render: function (data, type, row) {
							return "<a class='btn btn-default btn-sm btn-flat js-view'  href='/admin/roads/show/ "+ row.id +"' data-id='" + row.id + "'> " +
								"<i class='glyphicon glyphicon-edit'></i></a>" +
								"<button class='btn btn-danger btn-sm btn-flat js-delete' data-id='" + data +
								"' data-url='/admin/roads/delete/" + row.id + "'> <i class='glyphicon glyphicon-trash'></i></button>";
						}
					}
				]
			});
...
//initialize data table
		...
		manageTable.on('click', '.js-delete', function () {
			var button = $(this);
			bootbox.confirm("Are you sure you want to delete this Road accident  record?", function (result) {
				if (result) {
					$.ajax({
